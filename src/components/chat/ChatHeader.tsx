...
function ChatHeader({name, serverId, type, imageUrl}: chatHeaderProps) {
  return (
    <div className="h-12 px-3 text-base font-semibold flex items-center w-full border-b-2 border-neutral-200 dark:border-neutral-800 bg-zinc-100 sticky top-0 dark:bg-zinc-800 z-50">
